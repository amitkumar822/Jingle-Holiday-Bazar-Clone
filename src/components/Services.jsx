...
const Services = () => {
  ...
  useEffect(() => {
    ...
    const container = mountRef.current?.parentNode;
  ...
  const serviceItems = [
    {
      ...
      subtitle: "Book Villas, Apartments and Resorts",
      description:
        "Jingle Holiday Bazar.com ventured into Homestays in India in 2015, and is providing... great homestay experiences to its customers as well as benefits to its hosts.",
      link: "#",
      icon: "🏡",
    ...
    },
    {
      ...
      subtitle: "Book Hotels with Jingle Holiday Bazar.com",
      description:
        "We are back in the post-pandemic world with a bouquet of hotels across Indian cities ranging... from leisure to business ones with a new outlook.",
      link: "#",
      icon: "🏨",
    ...
    },
    {
      ...
      subtitle: "Why to book Flights Online with Jingle Holiday Bazar.com",
      description:
        "Purchasing flight tickets and confirming your flight booking is the key aspect of planning a... trip.",
      link: "#",
      icon: "✈️",
    ...
    <div className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden h-[50rem]">
      ...
      <div className="relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            At Jingle Holiday Bazar, we are committed to ensuring that you save
            on every trip and every holiday booking you make with us.
          </p>
        </motion.div>
            ...
            >
              <motion.div variants={hoverVariants} className="h-full">
                <div className="p-8 h-full flex flex-col">
                  ...
                  <h4 className="text-lg font-semibold text-gray-700 mb-5">
                    {service.subtitle}
                  </h4>
