...
const footerLinks = {
  quickLinks: ["Home", "About Us", "Blog list", "Destinations", "Hotels", "Gallery"],
  domestic: ["Uttarakhand", "Mumbai", "Ladakh", "Meghalaya", "North East India", "Rajasthan"],
  international: ["Maldives", "Singapore", "Switzerland", "Saudi Arabia", "Thailand", "Dubai"],
  yatra: ["Mata Vaishno", "Kedarnath", "Badrinath", "Char Dham Yatra", "Ramayana Yatra", "9 Devi Yatra"],
};
      ...
      >
        <svg viewBox="0 0 1440 320" className="w-full h-40">
          <path
            fill="#1e3a8a"
            fillOpacity="0.4"
            d="M0,32L80,74.7C160,117,320,203,480,224C640,245,800,203,960,176C1120,149,1280,139,1360,133.3L1440,128L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"
          ></path>
        </svg>
      </motion.div>

      {/* Footer Content */}
      <div className="relative z-10 bg-gradient-to-b from-blue-900 to-blue-100 text-white py-12 px-6 md:px-16">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 text-sm">
          ...
          <div>
            ...
            {footerLinks.quickLinks.map((link) => (
              <p key={link} className="hover:text-blue-300 cursor-pointer">› {link}</p>
            ))}
          </div>
          <div>
        ...
        <div className="mt-8 border-t pt-4 text-xs flex justify-between items-center flex-wrap">
          <p>
            Powered By <a href="#" className="text-blue-300">Namrata Universal</a> | All Rights Reserved by Jingleholidaybazar
          </p>
